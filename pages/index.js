...
function SponsorLogo(props) {
  ...
  return (
    <div className={`${styles.elementListItem}`}>
      <a
        href={isPremium ? `sponsors/${id}` : link}
        rel="noreferrer"
        target="_blank"
      >
        <img src={logo} alt={`${name} Logo`} height="110px" width="300px" />
      </a>
    </div>
  );
}
          ...
          <div className={`${styles.heroGridItemSplash}`}>
            <div className={`${styles.heroSplashContainer}`}>
              ...
              <p>
                ...
                ! Check our Instagram for the location!
              </p>
              <a href="/get-involved">
        ...
        <div className={`${styles.heroFooterContent}`}>
          <div className={`${styles.heroFooterText}`}>
            ...
            <p>
              ...
              students' connections with the Donald Bren School of Information
              and Computer Sciences & UCI Alumni and improve them
          ...
          <Col lg={12} sm={12}>
            ...
            <div className={`${styles.elementList}`}>
              {Sponsors.map((sponsor) => (
                <SponsorLogo {...sponsor} key={sponsor.id} />
              ))}
            </div>
            <p>
